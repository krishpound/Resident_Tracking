...
<jsp:useBean id="CHANGEYEARPARM" type="resident_tracking.FormBean" scope="request" />
          ...
          <!--  inner panel table start -->
          		...
          		<table  align="center" border="0" cellpadding="1" cellspacing="0" height="60">
          			...
          			<tr>
        				...
        				<%
        						String yearChoice = CHANGEYEARPARM.getAcademicYear();
								...
								while (itr.hasNext()){							
									...
									year = itr.next();
									if (year.equalsIgnoreCase(yearChoice)){
										out.print("<option selected=\"selected\">"+year+"</option>");
									}
									else{
...
<center><font color="red">
			...
			<% 
				...
				if (false==CHANGEYEARPARM.getSqlStatus()){
			
					if (CHANGEYEARPARM.getMessage1() != null)
						out.print("<img src=\"images/error.gif\">&nbsp;"+CHANGEYEARPARM.getMessage1()+"<br><br>");
											
					if (CHANGEYEARPARM.getMessage2() != null)
						out.print(CHANGEYEARPARM.getMessage2()+"<br><br>");
					 
					if (CHANGEYEARPARM.getMessage3() != null)
						out.print(CHANGEYEARPARM.getMessage3()+"<br><br>");	 
	...
	<% 
		...
		if (CHANGEYEARPARM.getMessage1() != null){
				...
				out.print("<center><font color=\"#03328A\"><img src=\"images/ok.gif\"/>&nbsp;"+CHANGEYEARPARM.getMessage1()+"<br><br></font></center>");
 				out.print("<center><font color=\"#03328A\">&nbsp;"+CHANGEYEARPARM.getMessage2()+"</font></center>");
        }	
		else{
			out.print("CHANGEYEARPARM bean has no messages");
		}
