...
<form name="DetailQuery" action="detail.do" method="post">
	...
	<table style="background-color: #ffffff; border: #C3D9FF 1px solid" cellspacing="3" cellpadding="5" width=100% border="0" height="210" align="center">
          ...
          <!--  inner panel table start -->
          		...
          		<% System.out.println("All OK point A"); %>
          		...
          		<table  align="center" border="0" cellpadding="1" cellspacing="0" height="125">
          			...
          			<tr>
        				...
        				<td><input class="label"  type="text" id="startDate" name="startDate" size="12" value=<c:choose><c:when test="${HEADER_SECTION.startDate==null}">""</c:when><c:otherwise><c:out value="${HEADER_SECTION.startDate}"/></c:otherwise></c:choose>>
        			...
        			<% System.out.println("All OK point B"); %>
        			
        			<tr> 
        				<td colspan="2" align="right" height="30"><span class = lable>End Date :&nbsp;</span></td>
        				<td><input class="label"  type="text" name="endDate" size="12" value=<c:choose><c:when test="${HEADER_SECTION.endDate==null}">""</c:when><c:otherwise><c:out value="${HEADER_SECTION.endDate}"/></c:otherwise></c:choose>>
        				...
        				<td><select class="sort" name="menuSort">
        			...
        			<% System.out.println("All OK point C"); %>
        			...
        			<td>&nbsp;&nbsp;&nbsp;</td>	
        				...
        				<td colspan="2" align="right" height="30"><span class = lable>Resident :&nbsp;</span></td>
							...
							<c:set var="selection" value="${HEADER_SECTION.resident}" scope="request"/>
        			...
        			<% System.out.println("All OK point D"); %>
