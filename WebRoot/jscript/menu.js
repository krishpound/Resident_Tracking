...
// --------------------------------------------------------------------------------
// menu class
function menu (a_items, a_tpl,appContext) {

    // Assign application context path.
...
function menu_item (o_parent, n_order) {
	...
	document.write (
		'<div style="z-index:100; "><a id="e' + o_root.n_id + '_' 
			+ this.n_id +'o" class="' + this.getstyle(0, 0) + '" href="' + this.a_config[1] + '"'
//			+ this.n_id +'o" class="' + this.getstyle(0, 0) + '" href="'+ contextPath +'/aprovider.ew?'
//                        +'submitValue=menu&resource='+this.a_config[1]+'"'
			...
			+' z-index: ' + this.n_depth+9050 + ';" '    // this.n_depth   z-index:
			...
			+ this.n_id +'i"  wrap="wrap"  class="' + this.getstyle(1, 0) + '">'
			+ this.a_config[0] + "</div></a></div>\n"
		);
