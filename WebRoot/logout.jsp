...
<%@page import="resident_tracking.HeaderBean"%>
<% 
	String path = request.getContextPath();
	String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";

	Logger log = Logger.getLogger("logout.jsp");

	try { 
		HeaderBean hb = (HeaderBean)session.getAttribute("HEADER_SECTION");
		log.info(hb.getUserName()+" logout");	
	}
	catch(Exception ex) 
	{ 
		log.info("Someone tried to logout from a cached page, and no session exists. No harm done."); 
	}  
	finally{
		session.invalidate();
	}
...
<html>
    <head>
        ...
        <title>MSDW - Resident Tracking Logout</title>
...
<!-- TABLE #4 START -->
				<table height="34">
          					<tr>
          						...
          						<td align="centre" height="35">
       								<span class ="heading4" >You have successfully logged out of Resident Tracking.  &nbsp;Thank you.</span>
          						</td>
          					</tr>
          					...
          					<tr>
          						...
          						<td align="center" height="25">
       								<a href="http://localhost:8080/Resident_Tracking/"><span class ="heading4">Click here to sign back in.</span></a>
          						</td>
          					</tr>
							...
							<tr>
          						...
          						<td align="center" height="25">
       								<a href="http://localhost:8080/Resident_Tracking/"><span class ="heading4">Return to Mount Sinai Data Warehouse.</span></a>
          						</td>
          					</tr>
