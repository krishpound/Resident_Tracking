    ...
    <head>
    	...
    	<script language="JavaScript" type="Text/JavaScript"> 
			function loadFunction() {  
				maintainResidentsForm.dictationID.focus();	
          ...
          <!--  inner panel table start -->
          		...
          		<table  align="center" border="0" cellpadding="1" cellspacing="0" height="125">
          			...
          			<tr>
        				...
        				<td><input class="textField"  type="text" name="dictationID" size="10"></td>       				
        				<td>&nbsp;&nbsp;&nbsp;</td>
        			...
        			<tr>
        				<td colspan="2" align="right" height="30"><span class = lablel>Status :&nbsp;</span></td>
        				...
        				<td colspan="2" align="right" height="30"><span class = label>Employer :&nbsp;</span></td>
...
<%
	...
	if (HEADER_SECTION.getAdministrator()==false){
		...
		out.print("<center><font color=\"#03328A\"><img src=\"images/info.gif\"/>&nbsp;Please enter a valid Cactus Dictation ID.</font></center><br>");	
	}
%>
