...
<jsp:useBean id="MAINTAINUSERPARM" type="resident_tracking.FormBean" scope="request" />
    ...
    <head>
    	...
    	<script language="JavaScript" type="Text/JavaScript"> 
			function loadFunction() {  
				...
				var msg = '<%=MAINTAINUSERPARM.getMessage1()%>';
				...
				if (msg == 'Please enter a value in the Last Name field.'){
					...
					var focus_fld = 'userID';
				}
						
				eval('maintainUserForm.'+focus_fld+'.focus()');	
...
<form name="maintainUserForm" method="post" action="maintainUsers.do">
          		...
          		<table style="background-color: #ffffff; border: #03328A 1px solid" cellspacing="3" cellpadding="5" width=300 border="0" height="10" align="center">
          			<tr>
          				<td valign="top" style="text-align:center" nowrap="nowrap" class="title" height="20">
          					<span class="heading3">User Maintenance</span>	
          				</td>
        			</tr>
				</table>
                <br> 		
          <!--  inner panel table start -->
          		...
          		<table  align="center" border="0" cellpadding="1" cellspacing="0" height="125">
          			...
          			<tr>
        				...
        				<td><input class="textField"  type="text" name="userID" size="10" value="<%=MAINTAINUSERPARM.getUserID()%>">
        				</td>       				
        				<td>&nbsp;&nbsp;&nbsp;</td>
        				
        				<td colspan="2" align="right" height="30"><span class = lable>Last Name :&nbsp;</span></td>
        				<td><input class="textField"  type="text" name="lastName" size="30" value="<%=MAINTAINUSERPARM.getLastName()%>">
        				</td>      
        				 				
        			</tr>
        			<tr> 
        				<td colspan="2" align="right" height="30"><span class = lable>First Name :&nbsp;</span></td>
        				<td><input class="textField"  type="text" name="firstName" size="30" value="<%=MAINTAINUSERPARM.getFirstName()%>">
        				</td> 
        				
        				<td>&nbsp;&nbsp;&nbsp;</td>
        				<td colspan="2" align="right" height="30"><span class = lable>Degree :&nbsp;</span></td>
        				<td><input class="textField"  type="text" name="degree" value="<%=MAINTAINUSERPARM.getDegree()%>" size="10"></td> 
        			...
        			<tr>
        				...
        				<td><select name="positionList">	
        					...
        					<%	
								List<String> data1= (List<String>)session.getValue("ALL_POSITIONS");
								Iterator<String> itr1 = data1.iterator();
								String position=null;
								String position_choice = MAINTAINUSERPARM.getTitle();
								...
								while (itr1.hasNext()){							
									...
									if ((position.equalsIgnoreCase("all positions")) || 
										...
										if (position.equalsIgnoreCase(position_choice)){
											out.print("<option selected=\"selected\">"+position+"</option>");
										}
										else{
        				...
        				<td><select name="programList">	
        					<%
								...
								String program=null;
								String program_choice = MAINTAINUSERPARM.getProgram();
        			...
        			<tr>
        				...
        				<td><select name="siteList">	
        					<%
									...
									String site_choice = MAINTAINUSERPARM.getSite();
									String site=null;
									...
									while (itr4.hasNext()){							
										...
										if (site.equalsIgnoreCase(site_choice)){
											out.print("<option selected=\"selected\">"+site+"</option>");
										}
										else{
											out.print("<option>"+site+"</option>");
										}
									}
          		...
          		<table style="background-color: #ffffff; border: #03328A 1px solid" cellspacing="3" cellpadding="5" width=200 border="0" height="10" align="center">
          			<tr>
          				...
          				<%
          					String sql_command_choice = MAINTAINUSERPARM.getSqlAction();
	...
	<center><font color="red">
			...
			<% 
				...
				if (false==MAINTAINUSERPARM.getSqlStatus()){
			
					if (MAINTAINUSERPARM.getMessage1() != null)
						out.print("<img src=\"images/error.gif\">&nbsp;"+MAINTAINUSERPARM.getMessage1()+"<br><br>");
											
					if (MAINTAINUSERPARM.getMessage2() != null)
						out.print(MAINTAINUSERPARM.getMessage2()+"<br><br>");
					 
					if (MAINTAINUSERPARM.getMessage3() != null)
						out.print(MAINTAINUSERPARM.getMessage3()+"<br><br>");	 
					 					 					
				}
				else{
				
					if (MAINTAINUSERPARM.getRowsUpdated()==0){
						out.print("<center><font color=\"#03328A\"><img src=\"images/info.gif\"/>&nbsp;There were 0 rows affected by your "+MAINTAINUSERPARM.getSqlAction().toLowerCase()+" command.</font></center>");
					}
					else{				
						out.print("<center><font color=\"#03328A\"><img src=\"images/ok.gif\"/>&nbsp;Resident Tracking has applied your "+MAINTAINUSERPARM.getSqlAction().toLowerCase()+" command successfully.</font></center>");
					}	 	
				}	
