		...
		<table>
			...
			<td>&nbsp;&nbsp;&nbsp;</td>
        				...
        				<td><select name="userList">
        					...
        					<c:forEach items="${sessionScope.ALL_USERS}" var="item">
        						<option>${item}</option>
    						</c:forEach>
			...
			<td colspan="2" align="right" height="30"><span class = lable>Filter :&nbsp;</span></td>
        				...
        				<td><select name="filterList">
        					...
        					<option selected="selected">All Positions</option>
        					<option>Program Directors</option>
        					<option>Program Coordinators</option>
        					</select>
        			</td>		
			...
			<td colspan="2" align="right" height="30"><span class = lable>Program :&nbsp;</span></td>
        		...
        		<td colspan="2" align="right" height="30"><span class = lable>Sort Order :&nbsp;</span></td>
        				...
        				<td><select name="sortList">
        					<option selected="selected">Name Asc</option>
        					<option>Name Desc</option>
        					<option>Program Asc</option>
        					<option>Program Desc</option>
        				</select></td>	
