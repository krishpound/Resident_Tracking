...
public class ProducerHSM implements DatasetProducer, CategoryToolTipGenerator, CategoryItemLinkGenerator, 
Serializable {

	private DataSource ds; 
    
    static Logger log = Logger.getLogger("ProducerHSM");
    ...
    public Object produceDataset(Map params) throws DatasetProduceException {
    	...
    	System.out.println("Hello from ProducerHSM!");
        ...
        try{
        	...
        	***/
        	...
        	if (FILTER.equalsIgnoreCase("or - exceptions")){
